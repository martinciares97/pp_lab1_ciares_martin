...
def menu_app(lista_jugadores):
    ...
    while True:
        ...
        match (option):
            ...
            case "2":
                mostrar_estadisticas_completas_de_jugador(lista_jugadores, lista_indice_jugadores,'estadisticas')
            case "3":
...
# 2º ---------------------------------------------------------------------
def mostrar_estadisticas_completas_de_jugador(
    lista_jugadores: list, list_indice_jugadores: list, key:str
) -> dict:
    """
    ...
    dict_estadisticas = lista_jugadores[indice_jugador][key]
    print(
        "\nESTADISTICAS DE {0}\n".format(
